...
<html>
    ...
    String qry="delete from suggestion where time='"+studid+"' ";
    if(smt.executeUpdate(qry)>0)
    {
    response.sendRedirect("suggestion.jsp?i=Deleted Succesfully");
    }
    else
    {
    response.sendRedirect("suggestion.jsp?i=Unable to Delete");
    }
